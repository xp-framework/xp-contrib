...
public class EascClient {
     ...
     *
     */
    protected EascClient(ProtocolHandler handler) {
     ...
     *
     */
    protected static EascClient acquire(DSN dsn) {
     ...
     *
     */
    protected static EascClient acquire(String dsn) {
     ...
     *
     */
    public static EascClient forName(String... dsns) {
        try {
     ...
     *
     */
    public static EascClient forName(String dsns) throws IllegalArgumentException {
