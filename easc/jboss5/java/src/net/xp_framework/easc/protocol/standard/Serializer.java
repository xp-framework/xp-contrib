 ...
 *
 * $Id: Serializer.java 12722 2009-01-18 12:45:57Z friebe $ 
 */
...
public class Serializer {
    ...
    private static enum Token implements TokenHandler {
        ...
        static {
            ...
            tokenMap.put('e', T_EXCEPTION); //FIXME: this is a quick bugfix, is 'E' correct or should it be only 'e' ?
    ...
    public static Invokeable<?, ?> invokeableFor(Class c) {
        ...
        for (Class key: typeMap.keySet()) {
            if (!(key.isAssignableFrom(c) || c.isInstance(key))) continue;
