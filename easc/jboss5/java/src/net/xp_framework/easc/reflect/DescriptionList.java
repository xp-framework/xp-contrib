 ...
 *
 * $Id: DescriptionList.java 6601 2006-02-14 13:30:40Z friebe $
 */
...
public class DescriptionList implements Serializable {
    ...
    /**
     * indicates whether there exists a BeanDescrition with a given name
     * @param name
     * @return
     */
    public boolean copyContainsDescriptionOf(String name)
    {
