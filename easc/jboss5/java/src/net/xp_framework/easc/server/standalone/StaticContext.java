 ...
 *
 * $Id: StaticContext.java 11854 2008-03-22 14:14:59Z kiesel $
 */
...
public class StaticContext implements Context {
    protected static HashMap<String, Object> bindings = new HashMap<String, Object>();
     ...
     * <tt>NameNotFoundException</tt> if any of the intermediate contexts do
     * not exist.
     * 
     * <p>
     ...
     * atomic component of the name. If the object bound to <tt>name</tt> is
     * not a link, returns the object itself.
     * 
     * @param name
     *            the name of the object to look up
     ...
     * Given a name (<code>name</code>) relative to this context, and the
     * name (<code>prefix</code>) of this context relative to one of its
     ...
     * <code>name</code> names an object relative to this context, the result
