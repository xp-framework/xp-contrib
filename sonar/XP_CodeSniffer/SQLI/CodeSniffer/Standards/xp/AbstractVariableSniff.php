 ...
 * @version   CVS: $Id: AbstractVariableSniff.php 12553 2010-12-08 17:09:23Z gelli $
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */

if (class_exists('SQLI_CodeSniffer_Standards_xp_AbstractScopeSniff', true) === false) {
    $error = 'Class SQLI_CodeSniffer_Standards_xp_AbstractScopeSniff not found';
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
abstract class SQLI_CodeSniffer_Standards_xp_AbstractVariableSniff extends SQLI_CodeSniffer_Standards_xp_AbstractScopeSniff
{
