 ...
 * @version   CVS: $Id: MultipleStatementAlignmentSniff.php 12553 2010-12-08 17:09:23Z gelli $
...
class xp_Sniffs_Core_MultipleStatementAlignmentSniff implements PHP_CodeSniffer_Sniff
{
     ...
     * @return bool
     */
    protected function nestedInCondition($tokens, $stackPtr) {
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($this->nestedInCondition($tokens, $stackPtr)) return;
