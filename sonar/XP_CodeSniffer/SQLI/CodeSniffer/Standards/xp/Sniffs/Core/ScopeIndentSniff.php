 ...
 * @version   CVS: $Id: ScopeIndentSniff.php 12553 2010-12-08 17:09:23Z gelli $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class xp_Sniffs_Core_ScopeIndentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$firstToken]['column'] !== $expectedIndent) {
            ...
            $phpcsFile->addEvent(
              'XP_SCOPE_INDENT_LINE_INDENTED_INCORRECTLY', 
              array('message'=> $error),
              $stackPtr
            );
        }
    ...
    protected function calculateExpectedIndent(array $tokens, $stackPtr)
    {
        ...
        return ((count($conditionStack) * $this->indent) + 3);
